...
from Emeitzvipapi import OfficialGoodShit
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '{34}: Change Account Password      2.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{35}: Change Account Email      2.5K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{0} : Exit'))
            
            print(Colorate.Horizontal(Colors.red_to_yellow, '===============[ ᴠɪᴘᴇᴍʀɪᴛᴢ ]==============='))

...
__ENDPOINT_URL__: str = "https://brixtoolenc.squareweb.app/api"
...
class OfficialGoodShit:
    ...
    def hack_car_sexo(self) -> bool:
        ...
        params = {"key": self.access_key}
        response = requests.post(
            f"{__ENDPOINT_URL__}/hack_car_sexo", params=params, data=payload
        )
        response_decoded = response.json()
        return response_decoded.get("ok")                
    ...
    def chrome_all_cars(self) -> bool:
        ...
        params = {"key": self.access_key}
        response = requests.post(
            f"{__ENDPOINT_URL__}/chrome_all_cars", params=params, data=payload
        )
        response_decoded = response.json()
        return response_decoded.get("ok")                        
    ...
    def unlock_animations(self) -> bool:
        ...
        params = {"key": self.access_key}
        response = requests.post(
            f"{__ENDPOINT_URL__}/hack_car_milage", params=params, data=payload
        )
        response_decoded = response.json()
        return response_decoded.get("ok")                     

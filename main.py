        ...
        while True:
            ...
            if service == 5: # Change Name
                ...
                if len(new_name) >= 0 and len(new_name) <= 999999999:
                    ...
                    sleep(2)
                    continue
            if service == 6: # Change Name Rainbow
            ...
            if service == 10: # Delete Friends
                ...
                if cpm.delete_player_friends():
                    ...
                    sleep(2)
                    continue
            if service == 11: # Unlock All Paid Cars
            ...
            if service == 12: # Unlock All Cars
                ...
                if cpm.unlock_all_cars():
                    ...
                    sleep(2)
                    continue
            if service == 13: # Unlock All Cars Siren
                ...
                if cpm.unlock_all_cars_siren():
                    ...
                    sleep(2)
                    continue
            if service == 14: # Unlock w16 Engine
                ...
                if cpm.unlock_w16():
                    ...
                    sleep(2)
                    continue
            if service == 15: # Unlock All Horns
                ...
                if cpm.unlock_horns():
                    ...
                    sleep(2)
                    continue
            if service == 16: # Disable Engine Damage
            ...
            if service == 23: # Unlock Smoke
                ...
                if cpm.unlock_equipments_female():
                    ...
                    sleep(2)
                    continue
            if service == 24: # Change Races Wins
                ...
                if amount > 0 and amount <= :
                    ...
                    sleep(2)
                    continue
            if service == 25: # Change Races Loses

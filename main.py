...
def load_key_data(cpm):
    ...
    console.print(
        "[bold][green]========[/green][ 𝐀𝐂𝐂𝐄𝐒𝐒 𝐊𝐄𝐘 𝐃𝐄𝐓𝐀𝐈𝐋𝐒 ][green]========[/green][/bold]"
    )

    console.print(
        f"[bold white]   >> Access Key  [/bold green]: [black]{data.get('access_key')}[/black]"
    )
...
def load_client_details():
    ...
    data = response.json()
    console.print(
        "[bold red] =============[bold green][ 𝐋𝐎𝐂𝐀𝐓𝐈𝐎𝐍 ][/bold green]=============[/bold red]"
    )
    console.print(
        f"[bold white]    >> Country    : {data.get('country')} {data.get('zip')}[/bold white]"
    )
    console.print(
        "[bold red] ===============[bold green][ ＭＥＮＵ ][/bold green]===========[/bold red]"
    )

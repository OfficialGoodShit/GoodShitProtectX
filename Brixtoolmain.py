...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{29}: Speed Car Hack (CarID)    1.5k'))
            print(Colorate.Horizontal(Colors.rainbow, '{30}: Speed All Cars Hack    2.5k'))
            print(Colorate.Horizontal(Colors.rainbow, '{31}: Chrome All Cars    3.5k'))
            print(Colorate.Horizontal(Colors.rainbow, '{32}: All Cars Max Milage   2.5k'))
            ...
            elif service == 29: # Hack Car Speed (299hp)
            ...
            elif service == 30: # Hack All Car Speed 99hp
                print(Colorate.Horizontal(Colors.rainbow, '[!] NOTE: ORIGINAL SPEED CAN NOT BE RESTORED'))            
            ...
            elif service == 31: # Chrome All Cars
            ...
            elif service == 32: # ALL CARS MAX MILAGE

...
def banner(console):
    ...
    console.print(
        "[bold green]       𝗣𝗟𝗘𝗔𝗦𝗘 𝗟𝗢𝗚 𝗢𝗨𝗧 𝗙𝗥𝗢𝗠 𝗖𝗣𝗠 𝗕𝗘𝗙𝗢𝗥𝗘 𝗨𝗦𝗜𝗡𝗚 𝗧𝗛𝗜𝗦 𝗧𝗢𝗢𝗟[/bold green]"
    )
    console.print("[bold orange]           𝗦𝗛𝗔𝗥𝗜𝗡𝗚 𝗧𝗛𝗘 𝗔𝗖𝗖𝗘𝗦 𝗞𝗘𝗬 𝗜𝗦 𝗡𝗢𝗧 𝗔𝗟𝗟𝗢𝗪𝗘𝗗[/bold orange]")
    console.print(                      
        "[bold red] ✧───────────────────────────────────────────────────────✧[/bold red]"
    )
...
def load_player_data(cpm):
    ...
    console.print(
        "[bold green]========[white] PLAYER DETAILS [/white]========[/bold green]"
    )

    console.print(
        f"[bold red]   >> Name        : {data.get('Name', 'UNDEFINED')}[/bold red]"
    )
    console.print(
        f"[bold green]   >> LocalID     : {data.get('localID', 'UNDEFINED')}[/bold green]"
    )
    console.print(
        f"[bold green]   >> Moneys      : {data.get('money', 'UNDEFINED')}[/bold green]"
    )
    console.print(
        f"[bold red]   >> Coins       : {data.get('coin', 'UNDEFINED')}[/bold red]"
    )
...
def load_key_data(cpm):
    ...
    console.print(
        f"[bold yellow]   >> Access Key  [/bold yellow]: [black]{data.get('access_key')}[/black]"
    )
...
def load_client_details():
    ...
    console.print(
        f"[bold green]    >> Country    : {data.get('country')} {data.get('zip')}[/bold green]"
    )
    console.print(
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print(
                "[bold red][bold green](01)[/bold white]: Increase Money                 [bold red]1.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](02)[/bold white]: Increase Coins                 [bold red]1.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](03)[/bold white]: King Rank                      [bold red]8K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](04)[/bold white]: Change ID                      [bold red]4.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](05)[/bold white]: Change Name                    [bold red]100[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](06)[/bold white]: Change Name (Rainbow)          [bold red]100[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](07)[/bold white]: Number Plates                  [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](08)[/bold white]: Account Delete                 [bold red]Free[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](09)[/bold white]: Account Register               [bold red]Free[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](10)[/bold white]: Delete Friends                 [bold red]500[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](11)[/bold white]: Unlock Lamborghinis (ios only) [bold red]5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](12)[/bold white]: Unlock All Cars                [bold red]6K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](13)[/bold white]: Unlock All Cars Siren          [bold red]3.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](14)[/bold white]: Unlock W16 Engine              [bold red]4K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](15)[/bold white]: Unlock All Horns               [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](16)[/bold white]: Unlock Disable Damage          [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](17)[/bold white]: Unlock Unlimited Fuel          [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](18)[/bold white]: Unlock Home 3                  [bold red]4K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](19)[/bold white]: Unlock Smoke                   [bold red]4K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](20)[/bold white]: Unlock Wheels                  [bold red]4K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](21)[/bold white]: Unlock Animations              [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](22)[/bold white]: Unlock Equipaments M           [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](23)[/bold white]: Unlock Equipaments F           [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](24)[/bold white]: Change Race Wins               [bold red]1K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](25)[/bold white]: Change Race Loses              [bold red]1K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](26)[/bold white]: Clone Account                  [bold red]7K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](27)[/bold white]: Custom HP                      [bold red]2.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](28)[/bold white]: Custom Angle                   [bold red]1.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](29)[/bold white]: Custom Tire burner             [bold red]1.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](30)[/bold white]: Custom Car Millage             [bold red]1.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](31)[/bold white]: Custom Car Brake               [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](32)[/bold white]: Remove Rear Bumper             [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](33)[/bold white]: Remove Front Bumper            [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](34)[/bold white]: Change Account Password        [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](35)[/bold white]: Change Account Email           [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](36)[/bold white]: Custom Spoiler                 [bold red]10K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](37)[/bold white]: Custom BodyKit                 [bold red]10K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](38)[/bold white]: Unlock Premium Wheels          [bold red]4.5K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](39)[/bold white]: Unlock Toyota Crown            [bold red]2K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](40)[/bold white]: Unlock Clan Hat (M)            [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](41)[/bold white]: Remove Head Male               [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](42)[/bold white]: Remove Head Female             [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](43)[/bold white]: Unlock Clan Top 1 (M)          [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](44)[/bold white]: Unlock Clan Top 2 (M)          [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](45)[/bold white]: Unlock Clan Top 3 (M)          [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](46)[/bold white]: Unlock Clan Top 1 (FM)         [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](47)[/bold white]: Unlock Clan Top 2 (FM)         [bold red]3K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](48)[/bold white]: Unlock Mercedes Cls            [bold red]4K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](49)[/bold white]: Stance Camber                  [bold red]1K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold green](0) [/bold white]: Exit From Tool [/bold red]"
            )

            console.print(
                "[bold red]===============[bold white][ EmritzVip ][/bold white]===============[/bold red]"
            )
            ...
            if service == 0:  # Exit
                ...
                if answ == "y":
                    ...
                    console.print(
                        "[bold red] f'Thank You for using our tool, please join our telegram channe: @EmritzVip[/bold red]"
                    )
                else:
                    continue

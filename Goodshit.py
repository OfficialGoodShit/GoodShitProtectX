...
def banner(console):
    ...
    brand_name += "                ╱╱╱╱╱╱╱╰╯\n"
    colors = [
        "rgb(199, 1, 4)", "rgb(32, 24, 202)", "rgb(199, 1, 4)", "rgb(32, 24, 202)", "rgb(199, 1, 4)", 
        "rgb(32, 24, 202)", "rgb(199, 1, 4)", "rgb(32, 24, 202)", "rgb(199, 1, 4)", "rgb(32, 24, 202)",
        "rgb(199, 1, 4)"
    ]
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            print(Colorate.Horizontal(Colors.rainbow, f'ɴᴀᴍᴇ   : {(data.get("Name") if "Name" in data else "UNDEFINED")}.'))
                
            print(Colorate.Horizontal(Colors.rainbow, f'ʟᴏᴄᴀʟɪᴅ: {data.get("localID")}.'))
            
            print(Colorate.Horizontal(Colors.rainbow, f'ᴍᴏɴᴇʏ  : {data.get("money")}.'))
            
            print(Colorate.Horizontal(Colors.rainbow, f'ᴄᴏɪɴꜱ  : {data.get("coin")}.'))
            
        else:
            print(Colorate.Horizontal(Colors.rainbow, '! ᴇʀʀᴏʀ: new accounts most be signed-in to the game at least once !.'))
            exit(1)
    else:
        print(Colorate.Horizontal(Colors.rainbow, '! ᴇʀʀᴏʀ: seems like your login is not properly set !.'))
        exit(1)
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, f'ᴀᴄᴄᴇꜱꜱ ᴋᴇʏ : {data.get("access_key")}.'))
    
    print(Colorate.Horizontal(Colors.rainbow, f'ᴛᴇʟᴇɢʀᴀᴍ ɪᴅ: {data.get("telegram_id")}.'))
    
    print(Colorate.Horizontal(Colors.rainbow, f'ʙᴀʟᴀɴᴄᴇ $  : {(data.get("coins") if not data.get("is_unlimited") else "Unlimited")}.'))
...
def load_client_details():
    ...
    print(Colorate.Horizontal(Colors.rainbow, f'ɪᴘ ᴀᴅᴅʀᴇꜱꜱ : {data.get("query")}.'))
    print(Colorate.Horizontal(Colors.rainbow, f'ʟᴏᴄᴀᴛɪᴏɴ   : {data.get("city")} {data.get("regionName")} {data.get("countryCode")}.'))
    print(Colorate.Horizontal(Colors.rainbow, f'ᴄᴏᴜɴᴛʀʏ    : {data.get("country")} {data.get("zip")}.'))
    ...
    while True:
        ...
        if login_response != 0:
            if login_response == 100:
                print(Colorate.Horizontal(Colors.rainbow, 'ᴀᴄᴄᴏᴜɴᴛ ɴᴏᴛ ꜰᴏᴜɴᴅ.'))
                sleep(2)
                continue
            elif login_response == 101:
                print(Colorate.Horizontal(Colors.rainbow, 'ᴡʀᴏɴɢ ᴘᴀꜱꜱᴡᴏʀᴅ.'))
                sleep(2)
                continue
            elif login_response == 103:
                print(Colorate.Horizontal(Colors.rainbow, 'ɪɴᴠᴀʟɪᴅ ᴀᴄᴄᴇꜱꜱ ᴋᴇʏ.'))
                sleep(2)
                continue
            else:
                print(Colorate.Horizontal(Colors.rainbow, 'ᴛʀʏ ᴀɢᴀɪɴ.'))
                print(Colorate.Horizontal(Colors.rainbow, '! ɴᴏᴛᴇ: ᴍᴀᴋᴇ ꜱᴜʀᴇ ʏᴏᴜ ꜰɪʟʟᴇᴅ ᴏᴜᴛ ᴛʜᴇ ꜰɪᴇʟᴅꜱ !.'))
                sleep(2)
                continue
        else:
            print(Colorate.Horizontal(Colors.rainbow, 'ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟ.'))
            sleep(2)
        while True:
            banner(console)
            ...
            if service == 0: # Exit
                ...
                if amount > 0 and amount <= 500000000:
                    if cpm.set_player_money(amount):
                        ...
                        print(Colorate.Horizontal(Colors.rainbow, 'ꜰᴀɪʟᴇᴅ.'))
